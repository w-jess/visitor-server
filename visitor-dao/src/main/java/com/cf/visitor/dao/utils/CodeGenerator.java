package com.cf.visitor.dao.utils;
...
public class CodeGenerator {
	...
	public static final String[] tableArray = {"user"};
	public static final String[] tablePrefixArray = {""};
	public static final String packageName = "com.cf";
	public static final String moduleName = "visitor";

	public static final String url = "jdbc:mysql://127.0.0.1:3306/visitor?useUnicode=true&characterEncoding=UTF-8&zeroDateTimeBehavior=convertToNull&allowMultiQueries=true&serverTimezone=Asia/Shanghai";
...
//                .commentDate("yyyy-MM-dd") // 注释日期	默认值: yyyy-MM-dd
		...
		PackageConfig.Builder packageConfig = new PackageConfig.Builder()
				...
				.entity("visitor-dao.src.main.java.com.cf.visitor.dao.po") // Entity 包名	默认值:entity
				.service("visitor-services.src.main.java.com.cf.visitor.services.service") // Service 包名	默认值:service
				.mapper("visitor-dao.src.main.java.com.cf.visitor.dao.mapper") // Mapper 包名	默认值:mapper
				.xml("visitor-dao.src.main.resources.mapping") // Mapper XML 包名	默认值:mapper.xml
				;
